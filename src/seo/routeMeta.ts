...
export const routeMeta: RouteMeta[] = [
  {
    path: '/',
    title: 'SPARK - Fix Your Inventory in 14 Days',
    description:
      'Go live in minutes with a raw CSV import. Spark\'s AI tells you what to reorder, when, and how much. Your team approves, and Spark handles the rest.',
  },
  {
    path: '/3pl',

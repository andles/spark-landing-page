export const homeFaqs = [
  {
    question: 'Is Spark a forecasting tool or a full inventory management system?',
    answer:
      'Spark is a full inventory management platform with AI demand forecasting built in. It brings stock, orders, purchasing, warehousing, reporting, and accounting workflows together, then turns your sales history into reorder recommendations and draft purchase orders.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Spark is a fit for operators running inventory across wholesale, multiple warehouses, or a mix of channels, with or without a storefront. It is also a fit for manufacturers that need bills of materials and production visibility tied to live stock.',
  },
] as const;

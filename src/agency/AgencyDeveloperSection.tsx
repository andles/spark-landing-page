          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="relative" style={{ minHeight: "280px" }}>
                <div key={tab.id} className="absolute inset-0 opacity-100 pointer-events-auto transition-opacity duration-500">
                    <h3 className="text-xl sm:text-2xl lg:text-[1.7rem] font-bold text-white leading-snug mb-5 dev-content-enter" style={{ fontFamily: "var(--font-display, 'Inter', sans-serif)" }}>{tab.headline}</h3>
                    <ul className="space-y-3.5">
                      {tab.bullets.map((b, bi) => (
                        <li key={b} className="flex items-start gap-3 dev-bullet-in" style={{ animationDelay: `${150 + bi * 80}ms` }}>
            ...
            <div className="relative" style={{ minHeight: "300px" }}>
              ...
              {(() => {
                ...
                return (
                  <div key={active} className="absolute inset-0 flex items-center justify-center dev-mockup-panel overflow-hidden opacity-100 scale-100 translate-y-0">

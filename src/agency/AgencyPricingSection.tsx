    ...
    <section id="pricing" className="scroll-mt-16 py-14 lg:py-20 bg-[#06080d] relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <ScrollReveal className="text-center">
          ...
          <p className="mt-4 text-lg text-[#b8bfcc] max-w-2xl mx-auto">Choose the plan that fits your business. Start free for 14 days, with agent-guided onboarding included.</p>
        </ScrollReveal>

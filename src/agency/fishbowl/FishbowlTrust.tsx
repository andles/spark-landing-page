...
const points = [
  {
    title: "Get help from the Spark team",
    body:
  ...
  },
  {
    ...
    body:
      "We sit with you, look at your Fishbowl setup, and map it into Spark together. Vendors, BOMs, channels, the reports you run every Monday. Migration and onboarding are included in the Fishbowl switch offer.",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

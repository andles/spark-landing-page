...
export const competitorConfigs: Record<CompetitorKey, CompetitorConfig> = {
  cin7: {
    ...
    themes: [
      ...
      },
      {
        ...
        spark: 'Spark publishes four flat-rate tiers and does not publish an order-volume meter; AI actions are metered by plan.',
      },
      {
        number: '04',
        label: 'Agent access',
    ...
    comparison: [
      ...
      { category: 'Published price', competitor: 'Core: $349, $599, and $1,199 per month. Omni is quote-based.', spark: 'Starter $199, Professional $399, Business $749, plus Custom.', lean: 'spark' },
      ...
      { category: 'Order and integration limits', competitor: 'Published limits by Core tier, with more capacity available for purchase.', spark: 'No published order-volume limit; ecommerce connections and AI actions vary by plan.', lean: 'tradeoff' },
      { category: 'Manufacturing', competitor: 'Core has deeper MRP and advanced manufacturing options.', spark: 'BOMs, work orders, and shop-floor workflows on Business; not positioned as full MRP.', lean: 'competitor' },
  ...
  zoho: {
    ...
    snapshot: [
      ...
      { label: 'Spark', value: 'From $199/mo', note: 'Built around planning and approval' },
    ],
    ...
    themes: [
      {
        ...
        spark: 'Spark does not publish an order-volume ceiling; pricing scales by users, warehouses, capabilities, and AI volume.',
      },
      {
        number: '02',
      ...
      },
      {
        number: '05',
        label: 'Price honesty',
        title: 'Zoho wins the entry-price comparison',
        body: 'A credible comparison should say this plainly: Spark is not the cheaper stock ledger. It earns consideration only when planning depth or operating friction is worth the difference.',
        incumbent: 'Zoho has a forever-free plan and paid plans starting at $29 per organization per month when billed annually.',
        spark: 'Spark starts at $199 per month and is positioned as an inventory planning and execution system.',
      },
    ],
    comparison: [
      { category: 'Starting price', competitor: 'Forever-free plan; paid plans start at $29 per month billed annually.', spark: 'Starter begins at $199 per month.', lean: 'competitor' },
      { category: 'Order limits', competitor: '50, 500, 3,000, 7,500, or 15,000 orders per month by plan.', spark: 'No published order-volume ceiling; AI actions are metered by plan.', lean: 'spark' },
      ...
      { category: 'Manufacturing', competitor: 'Composite items and assemblies, without a full work-order manufacturing layer.', spark: 'BOMs, work orders, and shop-floor workflows on Business.', lean: 'spark' },
  ...
  inflow: {
    ...
    snapshot: [
      ...
      { label: 'Spark', value: 'From $199/mo', note: 'Planning and agent onboarding included' },
    ],
    ...
    themes: [
      ...
      },
      {
        ...
        spark: 'Spark does not publish an order-volume meter; ecommerce connections and AI actions vary by plan.',
      },
      {
        number: '03',
        label: 'Onboarding',
        ...
        spark: 'Agent-guided onboarding and consultative help are included in getting started.',
      },
      {
        number: '04',
        label: 'MCP',
    ...
    comparison: [
      { category: 'Starting price', competitor: '$129 per month billed annually for Entrepreneur.', spark: '$199 per month for Starter.', lean: 'competitor' },
      { category: 'Order limits', competitor: '100 monthly orders on Entrepreneur, 1,000 on Small Business, unlimited on Mid-Size.', spark: 'No published order-volume meter; AI actions are metered by plan.', lean: 'spark' },
      { category: 'Integrations', competitor: 'One, three, or five active integrations on public tiers; additional connections are available.', spark: 'Native commerce and accounting paths, with ecommerce connection limits varying by plan.', lean: 'tradeoff' },
      ...
      { category: 'Onboarding', competitor: '$499 package required on Small Business and above; extra services are $199 per hour.', spark: 'Agent-guided onboarding and consultative help are included in getting started.', lean: 'spark' },
      ...
      { category: 'Manufacturing', competitor: 'A separate inFlow Manufacturing product adds BOM and production workflows.', spark: 'BOMs, work orders, and shop-floor workflows are included on Business.', lean: 'tradeoff' },

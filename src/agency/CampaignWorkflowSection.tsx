...
const workflows: Record<CampaignKind, WorkflowContent> = {
  ...
  fishbowl: {
    eyebrow: "Database backup to Spark",
    title: "Drop it in. Sparki handles",
    gradientTitle: "the migration work",
    description:
      "Drop in your Fishbowl database backup and it is in Spark in minutes. Sparki does the mapping and you approve the import.",
    workspace: "FISHBOWL / MIGRATION RUN",
    promises: ["One database backup", "Sparki maps the data", "Approval before import"],
    accent: "violet",
    steps: [
      {
        label: "Inspect",
        title: "Understand the Fishbowl database",
        body: "Sparki profiles the backup, identifies the records and relationships, and orders the migration around the dependencies in your operation.",
        signals: ["Parts + products", "Customers + vendors", "Sales + purchasing"],
        resultLabel: "SOURCE PROFILE",
        resultValue: "Database understood",
        icon: ScanSearch,
      },
      {
        label: "Map",

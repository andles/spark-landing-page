      ...
      <div className="hidden lg:block absolute right-0 top-0 bottom-0 w-[50%]">
        <div className="relative h-full w-full">
          <video
            ...
            src="/media/hero-original-brand-v3.mp4"
            autoPlay
            loop
            muted
            playsInline
...
function HeroNextGen() {
  ...
  // Adjust font sizing for longer headlines (variants) vs short defaults
  const isLongHeadline = content.headline[0].length + content.headline[1].length > 30;
    ...
    <section className="pt-20 lg:pt-0 min-h-[85vh] relative overflow-hidden bg-black">
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[85vh] text-center py-12">
          ...
          <h1 className={`${h1Size} font-bold leading-[1.1] mb-8 tracking-tight max-w-5xl`}>
            <span className="text-white">{content.headline[0]}</span>
            <br />

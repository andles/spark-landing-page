  ...
  return (
    ...
    >
      ...
      <LegalSection title="Personal Info">
        <LegalTable
          ...
          rows={[
            ...
            ["Address, phone, race/ethnicity, political beliefs, sexual orientation, religion, other personal info", "No", "n/a", "n/a"],
          ]}
        />
      </LegalSection>
      ...
      <LegalSection title="Financial Info">
        <LegalTable
          headers={["Type", "Collected", "Purpose", "Required"]}
          rows={[["All categories", "No", "n/a", "n/a"]]}
        />
      </LegalSection>
      ...
      <LegalSection title="Location">
        <LegalTable
          headers={["Type", "Collected", "Purpose", "Required"]}
          rows={[["Approximate / Precise location", "No", "n/a", "n/a"]]}
        />
      </LegalSection>
